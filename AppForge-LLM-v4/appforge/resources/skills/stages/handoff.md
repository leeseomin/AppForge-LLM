...
V4 hardening: handoff must point the next maintainer to the specification, workflow, memory, and loop artifacts, plus the evidence proving those contracts were implemented and verified.
